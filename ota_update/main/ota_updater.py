...
class OTAUpdater:
    ...
    def download_and_install_update_if_available(self, wlan):
        if 'next' in os.listdir(self.module):
            if '.version_on_reboot' in os.listdir(self.modulepath('next')):
                ...
                self._download_and_install_update(latest_version, wlan)
        else:
            print('No new updates found...')

    def _download_and_install_update(self, latest_version, wlan):
        OTAUpdater.using_network(wlan)
